...
export function CreateAdModal() {
  ...
  async function handleCreateAd(event: FormEvent) {
    ...
    console.log("enviou o form", data);
  ...
  return (
    <Dialog.Portal>
      ...
      <Dialog.Content className="fixed bg-[#2A2634] py-8 px-10 rounded-lg w-[480px] shadow-black/25 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
